 ...
 *
 * Disassembly of dsdt.aml, Mon Mar  8 19:56:55 2021
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00010AB2 (68274)
 *     Revision         0x02
 *     Checksum         0xAD
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I"
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I", 0x00000088)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xD95D4A98, 0x0350)
        ...
        Device (PCI0)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                If ((Local1 >= 0x07D9))
                {
                    If ((M64L == Zero))
                    {
                        CreateQWordField (BUF0, \_SB.PCI0._Y1E._LEN, MSLN)  // _LEN: Length
                        MSLN = Zero
                    }
                    Else
                    {
                        ...
                        M2LN = M64L M2MN = M64B M2MX = ((M2MN + M2LN) - One)
                    }
                }
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xD9434E98, 0x10)
...
, 
    ...
    Scope (_SB.PCI0)
    {
        ...
        {
            "937308352451Genuine NVIDIA Certified SLI Ready Motherboard for GIGABYTEZ97X-GAMING3ecb9-Copyright 2014 NVIDIA Corporation All Rights Reserved-950249559801(R)"
        })
        Device (WMI1)
        {
